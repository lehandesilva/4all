...
ALTER TABLE "reviews_table" DROP CONSTRAINT "reviews_table_user_id_users_table_id_fk";
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "reviews_table" ADD CONSTRAINT "reviews_table_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
